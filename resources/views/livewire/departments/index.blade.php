            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('departments.create') }}" class="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700">
                            Add Department
                        </a>
                        @endcan
                    </div>
                    ...
                    <!-- Search -->
                    <div class="mb-6">
                        <input wire:model.live.debounce.300ms="search" type="search" placeholder="Search departments..." 
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($departments as $department)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">
                                                {{ $department->users->count() }} members
                                            </div>
                                        </td>
